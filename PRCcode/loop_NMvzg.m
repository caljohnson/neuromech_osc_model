...
%                      Loop_NMvzg.m
%                      ------- 
%  This program calculates periodic orbits (v) and  infinitesmal
%  phase response curves (z) in a giant parameter loop
%
...
save(['loopdata_box/tm_' num2str(t_m,'%.1e') '_c_' num2str(c) '.mat'],'v', 'z', 'ii', 'dt')
